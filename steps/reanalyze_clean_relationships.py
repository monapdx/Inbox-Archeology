"""
Analyze relationships_clean.csv and print summary stats + top relationships.
...
def analyze_clean(in_path: str, top_n: int = 20):
    rows = []
...
def main():
    parser = argparse.ArgumentParser(description="Analyze relationships_clean.csv")
    parser.add_argument("--in", dest="in_csv", default=str(Path("output") / "relationships_clean.csv"))
    parser.add_argument("--top", type=int, default=20)
    args = parser.parse_args()
    analyze_clean(args.in_csv, args.top)
